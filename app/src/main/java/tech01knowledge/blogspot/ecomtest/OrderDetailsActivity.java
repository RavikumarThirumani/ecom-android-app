...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        shippedBody = findViewById(R.id.packed_body);
        packedBody = findViewById(R.id.shipping_body);
        ...
        switch (model.getOrderStatus()) {
            ...
            case "out for Delivery" :
                ...
                deliveredDate.setText(String.valueOf(simpleDateFormat.format(model.getDeliveredDarw())));
       ...
       if (model.isCancellationRequested()) {
           ...
           cancelOrderBtn.setText("Cancellation is under process");
...
//               cancelOrderBtn.setEnabled(true);
        ...
        if (model.getDeliveryPrice().equals("FREE")) {
            ...
            totalItems.setText(totalItemsPrice.getText());

        } else {
            deliveryPrice.setText("Rs." + model.getDeliveryPrice() + "/-");
            totalItems.setText("Rs." + (totalItemspriceValue + Long.valueOf(model.getDeliveryPrice())) + "/-");
        ...
        if (!model.getCuttedPrice().equals("")) {
            ...
            if (!model.getDeliveryPrice().equals("")) {
